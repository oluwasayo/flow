...
* fragmentConfigurationFile `default: ${project.basedir}/fragment-configuration.json`
...
fragments defined and inspect the produced `vaadin-flow-bundle-manifest.json` file, which contains all the front-end dependencies
found in your projects run time classpath.
The produced bundle can be found in the location defined by the `transpileOutputDirectory` parameter, which defaults to
...
<plugin>
    ...
    <executions>
        <execution>
            ...
            <configuration>
                <bundle>true</bundle>
                <fragmentConfigurationFile>${path.to.json.file.declared.above}</fragmentConfigurationFile>
            </configuration>
        </execution>
    </executions>
</plugin>
